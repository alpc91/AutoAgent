...
'''根据以下提供的文档内容撰写一篇笔记。笔记应整合所有能够帮助回答指定问题的相关原文信息，并形成一段连贯的文本。请确保笔记包含所有对回答问题有用的原文信息。除了使用原文信息外，如果原文信息是英文的，请再附上中文翻译。
...
'''任务：根据笔记，提出两个新问题。这些新问题将用于检索文档，以补充笔记并帮助回答原始问题。新问题应简明扼要，并包括有利于检索的关键词。新问题应避免与现有问题列表重复。如果原始文档是英文的，你提出的两个新问题应该是中英文对照的。
输出格式：
1. 问题1？
2. 问题2？
...
'''任务：根据检索到的文档，用尚未包含但对回答问题有用的内容补充笔记。补充内容应使用检索到的文档中的原始文本，并尽可能多的包含检索到的文档的信息。请确保笔记简洁凝练。如果原始文本是英文的，请再附上中文翻译。
